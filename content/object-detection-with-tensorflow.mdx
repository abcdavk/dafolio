...
summary: "Just For Fun | Simple detection object with tensor flow in react js"
tags: "Just For Fun, Project"
---
...
3. [Documentations](#documentations)
   ...
   - [Component Breakdown](#component-breakdown)
     ...
     - [Canvas for Drawing Bounding Boxes](#canvas-for-drawing-bounding-boxes)
     - [Object Detection and Drawing](#object-detection-and-drawing)
     - [Switching Camera](#switching-camera)
     - [Interval Control](#interval-control)
   - [Code Details](#code-details)
   - [UI Components](#ui-components)
   - [Example of Object Detection Output](#example-of-object-detection-output)
...
**[Link to website](https://simple-object-detection.vercel.app/)**

<ImageGrid
  columns={2}
  images={[
    { src: "/photos/content/object-detection-with-tensorflow/ss1.png", alt: "Photo1", href: "https://simple-object-detection.vercel.app/" },
    { src: "/photos/content/object-detection-with-tensorflow/ss2.png", alt: "Photo2", href: "https://simple-object-detection.vercel.app/" },
  ]}
/>
